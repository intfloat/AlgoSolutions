...
|[Godzilla and Ugly Number](http://codeforces.com/problemset/gymProblem/203881/V) | 把等号变成不等号，对于小于关系，枚举第一个数字是0目标是1的位，对于大于关系也是类似，代码似乎有bug。。。但是加了一个额外检查就AC，至于那个bug也没找出来。。。 | 数学 |
